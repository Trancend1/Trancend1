...
```txt
🧑‍💻  Informatics student building practical AI-assisted products, developer tools, and data-driven applications.
🔭  Currently building Weaver — a local-first JP→EN novel translation workbench with glossary, review, and export workflows.
🧠  Interested in AI tooling, agentic workflows, NLP, backend systems, and clean product architecture.
💓  I enjoy turning messy workflows into structured, useful, and developer-friendly tools.
...
> A calmer way to translate and shape digital stories.

Weaver is a translation workbench built for people who work with long-form Japanese digital novels and want a more organized way to translate, review, and refine their work.

Instead of treating translation as a one-time AI output, Weaver helps break the process into a clearer flow: importing the story, keeping chapters structured, translating in smaller parts, reviewing the results, and keeping names, terms, and writing style consistent across the project.

The goal is simple: make novel translation feel less scattered, more manageable, and easier to polish from start to finish.

**What Weaver helps with**

* Importing digital novel files into a structured workspace
* Keeping volumes, chapters, and text segments organized
* Translating chapter by chapter or segment by segment
* Managing glossary terms and character names
* Reusing previous translation decisions for consistency
* Reviewing AI-generated translation candidates
* Checking for missing, inconsistent, or suspicious translations
* Preparing translated content for export
* Working locally without requiring accounts or telemetry
...
![Status](https://img.shields.io/badge/STATUS-active%20development-orange.svg?\&style=flat)
...
[![Tailwind CSS](https://img.shields.io/badge/TAILWIND-06B6D4.svg?\&style=flat\&logo=tailwindcss\&logoColor=white)](https://tailwindcss.com/)
[![JavaScript](https://img.shields.io/badge/JAVASCRIPT-323330.svg?\&style=flat\&logo=javascript\&logoColor=%23F7DF1E)](https://developer.mozilla.org/en-US/docs/Web/JavaScript)
...
[![SQLite](https://img.shields.io/badge/SQLITE-003B57.svg?\&style=flat\&logo=sqlite\&logoColor=white)](https://www.sqlite.org/)
[![REST API](https://img.shields.io/badge/REST%20API-02569B.svg?\&style=flat\&logoColor=white)](https://restfulapi.net/)
[![Git](https://img.shields.io/badge/GIT-F05033.svg?\&style=flat\&logo=git\&logoColor=white)](https://git-scm.com/)
[![GitHub](https://img.shields.io/badge/GITHUB-121011.svg?\&style=flat\&logo=github\&logoColor=white)](https://github.com/)
